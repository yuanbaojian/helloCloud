...
public class ConfigConstants {
    ...
    /** SMG文件目录 */
    public static final String SMG_PATH = "Smg";


    /** WIData文件目录 */
    public static final String WIDATA_PATH = "WIData";
    ...
    /** OpContent文件目录 */
    public static final String OPCONTENT_PATH = "OpContent";
    ...
    /** 3D数据包模板目录 */
    public static final String TEMPLATE_3D = "3DTemplate";

    /** 下载AO数据的方法路径*/
    public static final String DOWNLOAD_AO = "downloadAo";
    ...
    /** 编制工具启动时请求的服务接口 */
    public static final String AO_DOWNLOAD = "core-ao/downloadAo";

    /** 编制工具保存时请求的服务接口 */
    public static final String AO_UPLOAD = "core-ao/uploadAo";
