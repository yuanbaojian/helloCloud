...
public class GeneratePaymentCenter {

    static String URL = "jdbc:mysql://10.98.32.103:6303/payment_center?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true";
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("/Users/lp211200227/IdeaProjects/payment/payment-service/src/main/java/");
        ...
        packageConfig.setParent("com.shopline.paymentacceptance.payment.infrastructure.persistence");     //设置父包名
