...
public class GenerateUtils {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("/Users/lp211200227/IdeaProjects/helloCloud/microService-crawler-8188/src/main/java");
        ...
        packageConfig.setParent("com.ybj.crawler");     //设置父包名
        ...
        strategyConfig.setInclude("refund_order");
