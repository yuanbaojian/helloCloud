...
public class P876MiddleOfTheLinkedList{
    public static void main(String[] args) {
        ...
        final ListNode listNode = solution.middleNode(listNode1);
        System.out.println("listNode.val = " + listNode.val);
        final ListNode listNode3 = solution.middleNode(listNode2);
        System.out.println("listNode3.val = " + listNode3.val);
