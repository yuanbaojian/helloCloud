...
// Related Topics 哈希表 链表 双指针 👍 1611 👎 0
...
public class P160IntersectionOfTwoLinkedLists{
    public static void main(String[] args) {
        ListNode listNode1 = new ListNode(4, new ListNode(1, new ListNode(8, new ListNode(4,new ListNode(5, null)) )));
        ListNode listNode2 = new ListNode(5, new ListNode(6, new ListNode(1, new ListNode(8,new ListNode(4, new ListNode(5,null))) )));
