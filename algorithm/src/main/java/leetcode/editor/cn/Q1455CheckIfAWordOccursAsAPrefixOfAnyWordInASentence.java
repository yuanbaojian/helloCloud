...
/** * @author  yuanbaojian * @date    2022-08-29 16:58:30 */
public class Q1455CheckIfAWordOccursAsAPrefixOfAnyWordInASentence{    //给你一个字符串 sentence 作为句子并指定检索词为 searchWord ，其中句子由若干用 单个空格 分隔的单词组成。请你检查检索词
...
// 
// Related Topics 字符串 字符串匹配 👍 72 👎 0
    public static void main(String[] args) {        
        Solution solution = new Q1455CheckIfAWordOccursAsAPrefixOfAnyWordInASentence().new Solution();
